...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // All 200 OK canonical routes (redirects excluded)
  const routes: { path: string; priority: number; changeFrequency: 'always' | 'hourly' | 'daily' | 'weekly' | 'monthly' | 'yearly' | 'never' }[] = [
    ...
    { path: '/dev-tools/csv-viewer', priority: 0.9, changeFrequency: 'weekly' },
    ...
    { path: '/pomodoro', priority: 0.8, changeFrequency: 'monthly' },
    ...
    { path: '/currency-exchange', priority: 0.6, changeFrequency: 'weekly' },
